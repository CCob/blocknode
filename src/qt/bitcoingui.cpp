                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Blocknode Core") + " - ";
#ifdef ENABLE_WALLET
...
*/
    ...
    labelWalletHDStatusIcon->setMaximumSize(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE);;
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Blocknode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blocknode: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBND"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Blocknode Core"), this);
    aboutAction->setStatusTip(tr("Show information about Blocknode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Blocknode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Blocknode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Blocknode addresses"));
    ...
    openAction->setStatusTip(tr("Open a Blocknode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Blocknode Core help message to get a list with possible Blocknode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Blocknode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Blocknode network", "", count));
}
...
{
    QString strTitle = tr("Blocknode Core"); // default title
