...
// Copyright (c) 2018 The Blocknode Core developers
 ...
 * Blocknode system. There are three: the main network on which people trade goods
...
public:
    ...
    inline int ExtCoinType() const { return nExtCoinType; }
    /** Zerocoin **/
